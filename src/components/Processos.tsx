      ...
      <div className="processos-cards">
        <div className="card-processos">
            <div className="flex-row-card-processos">
                 <img src="/check.png" alt="Ícone de Descobertas" />
                 <h1>Descobertas</h1>
            </div>
        ...
        <div className="card-processos">
            <div className="flex-row-card-processos">
                 <img src="/check.png" alt="Ícone de Planejamento" />
                 <h1>Planejamento</h1>
            </div>
        ...
        <div className="card-processos">
            <div className="flex-row-card-processos">
                 <img src="/check.png" alt="Ícone de Projeto" />
                 <h1>Projeto</h1>
            </div>
        ...
        <div className="card-processos">
            <div className="flex-row-card-processos">
                <img src="/check.png" alt="Ícone de Desenvolvimento" />
        ...
        <div className="card-processos">
            <div className="flex-row-card-processos">
                <img src="/check.png" alt="Ícone de Testes" />
                <h1>Testes</h1>
            </div>
        ...
        <div className="card-processos">
            <div className="flex-row-card-processos">
                <img src="/check.png" alt="Ícone de Lançamento" />
                <h1>Lançamento</h1>
            </div>
